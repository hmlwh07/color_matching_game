...
@Component({
  selector: 'app-for-easy-mode',
  templateUrl: './for-easy-mode.component.html',
  styleUrls: ['./for-easy-mode.component.css']
})
export class ForEasyModeComponent {
  ...
  gameStart(){
    this.randomColors = this.service.generateRandomColors(3);
    this.showColor = this.randomColors[Math.floor(Math.random() * 3)];
